...
public class testNewUser {
  ...
  public void testNewUser() throws Exception {
    initUserCreation();
    fillUserForm(new UserData("Pavel", "Chechnev", "Russia", "chechnev@mail.com"));
    submitUserCreation();
    checkNewUser();
    logoutAcc();
  }
  ...
  private void fillUserForm(UserData userData) {
    ...
    wd.findElement(By.name("lastname")).sendKeys(userData.getUserSoName());
    wd.findElement(By.name("address")).click();
    wd.findElement(By.name("address")).clear();
    wd.findElement(By.name("address")).sendKeys(userData.getUserAddress());
